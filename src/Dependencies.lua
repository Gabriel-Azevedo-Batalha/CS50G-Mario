...
gFrames = {
    ...
    ['keys_locks'] = GenerateQuads(gTextures['keys_locks'], TILE_SIZE, TILE_SIZE),
    ...
    ['flags'] = GenerateQuadsFlags(gTextures['flags'], 16, 16),
    ['poles'] = GenerateQuadsPoles(gTextures['poles'], 16, 16)
}
